...
class CarouselsControllerTest < ActionController::TestCase
  ...
  test "should create carousel" do
    assert_difference('Carousel.count') do
      post :create, carousel: { : @carousel., : @carousel., description: @carousel.description, title: @carousel.title }
    end
  ...
  test "should update carousel" do
    patch :update, id: @carousel, carousel: { : @carousel., : @carousel., description: @carousel.description, title: @carousel.title }
    assert_redirected_to carousel_path(assigns(:carousel))
  end
